...
// This file comes from https://raw.githubusercontent.com/ElgarL/Towny/master/src/com/palmergames/util/FileUtils.java
...
public class FileUtils {
	...
	public static File unpackResourceFile(String filePath, String resource, String defaultRes) {
		...
		if ((file.exists())/* && (!filePath.contains(FileUtils.fileSeparator() + defaultRes))*/)
			return file;
		...
		try {
			...
			FileUtils.stringToFile(resString, filePath);
